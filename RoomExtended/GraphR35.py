...
class Graph:
	def __init__(self, Nodes, alpha, delta, useSSA):
		...
		self.mExit		= Nodes.MNode("MExit",		1, alpha, delta, None, isMaxExitTerminal, [],			None, False)
		self.mGotoGoal	= Nodes.MNode("MGotoGoal",	2, alpha, delta, None, isMaxGotoGoalTerminal, ["G"],	None, False)
		self.mNav		= Nodes.MNode("MNav",		6, alpha, delta, None, isMaxNavTerminal, ["N", "S"],	bindForNav, False)
