class ActionSet:
	...
	## return the reward for a primitive (leaf-node)
	## action which partially depends on distance to
	## enemy, note that NO bonus is given for dropping
	## both units at the same time in one run
